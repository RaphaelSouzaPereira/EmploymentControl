...
public class VagaBeanTest {
    ...
    public void testConstrutors() {
        ...
        VagaBean vagabean2 = new VagaBean(status, pmp,
                ...
                categoria, null, dataAudit, motivoAtualizacao);
        ...
        assertTrue("DATAAUDIT não foi pego pelo construtor.", dataAudit.equals(vagabean2.getDataAudit()));
        assertEquals("MOTIVOATUALIZACAO não foi pego pelo construtor.", motivoAtualizacao, vagabean2.getMotivoAtualizacao());
    }
    ...
    public void testSetAndGetCandidatoCollection() {
     ...
     /**
     * Test of set and getDataAudir method, of class VagaBean.
     */
    @Test
    ...
    /**
     * Test of set and getMotivo method, of class VagaBean.
     */
    @Test
