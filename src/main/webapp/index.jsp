                    ...
                    <div class="panel-group" id="accordion">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered ibmec-table">
                                <thead class="ibmec-thead"> <!---------- Vagas Cadastradas - Head da tabela - Início ---------->
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr 
                                        class="collapse multi-collapse ibmec-tbody-tr-content-occult"
                                        id="vaga-<%= v.getId()%>"
                                        data-toggle="collapse"
                                        data-parent="#accordion"
                                        > <!---------- Vagas Cadastradas - Mais Detalhes da Vaga - Início ---------->                 
                                        <td class="ibmec-tbody-td" colspan="5">  
                                            <div class="row">
                                                <div class="col-6">
                                                    <ul class="list-group">
                                    ...
                                    <tr class="collapse multi-collapse ibmec-tbody-tr-content-occult" id="listar-historico-<%= v.getId()%>" data-toggle="collapse" data-parent="#accordion">
                                        <td colspan="5" class="ibmec-tbody-td">                        
