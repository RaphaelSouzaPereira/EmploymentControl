    ...
    <ul class="navbar-nav flex-row ml-md-auto d-md-none d-md-flex">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu mt-0 ibmec-menu-dropdown">
                <li><a class="nav-link py-1 px-1 menu-link ibmec-menu-link" href="./cadastro-candidato.jsp">Cadastrar</a></li>
                <li><a class="nav-link py-1 px-1 menu-link ibmec-menu-link" href="./editar-candidato.jsp">Atualizar</a></li>
            </ul>
        </li>
    </ul>
</header>
